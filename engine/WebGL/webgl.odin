...
foreign webgl {
	...
	CompressedTexImage2D    :: proc(target: Enum, level: i32, internalformat: Enum, width, height: i32, border: i32, imageSize: i32, data: rawptr) ---
	CompressedTexSubImage2D :: proc(target: Enum, level: i32, xoffset, yoffset, width, height: i32, format: Enum, imageSize: i32, data: rawptr) ---
	...
	ReadnPixels         :: proc(x, y, width, height: i32, format: Enum, type: Enum, bufSize: i32, data: rawptr) ---
	...
	TexImage2D    :: proc(target: Enum, level: i32, internalformat: Enum, width, height: i32, border: i32, format, type: Enum, size: i32, data: rawptr) ---
	TexSubImage2D :: proc(target: Enum, level: i32, xoffset, yoffset, width, height: i32, format, type: Enum, size: i32, data: rawptr) ---
	...
	VertexAttribPointer :: proc(index: i32, size: i32, type: Enum, normalized: bool, stride: i32, ptr: uintptr) ---
...
GetProgramInfoLog :: proc "contextless" (program: Program, buf: []byte) -> string {
	foreign webgl {
		...
		_GetProgramInfoLog :: proc "contextless" (program: Program, buf: []byte, length: ^i32) ---
	}
...
GetShaderInfoLog :: proc "contextless" (shader: Shader, buf: []byte) -> string {
	foreign webgl {
		...
		_GetShaderInfoLog :: proc "contextless" (shader: Shader, buf: []byte, length: ^i32) ---
	}
