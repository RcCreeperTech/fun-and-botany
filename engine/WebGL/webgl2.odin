...
foreign webgl2 {
	/* Buffer objects */
	CopyBufferSubData :: proc(readTarget, writeTarget: Enum, readOffset, writeOffset: i32, size: i32) ---
	GetBufferSubData  :: proc(target: Enum, srcByteOffset: i32, dst_buffer: []byte, dstOffset: i32 = 0, length: i32 = 0) ---
	...
	TexImage3D              :: proc(target: Enum, level: i32, internalformat: Enum, width, height, depth: i32, border: i32, format, type: Enum, size: i32, data: rawptr) ---
	TexSubImage3D           :: proc(target: Enum, level: i32, xoffset, yoffset, zoffset, width, height, depth: i32, format, type: Enum, size: i32, data: rawptr) ---
	CompressedTexImage3D    :: proc(target: Enum, level: i32, internalformat: Enum, width, height, depth: i32, border: i32, imageSize: i32, data: rawptr) ---
	CompressedTexSubImage3D :: proc(target: Enum, level: i32, xoffset, yoffset: i32, width, height, depth: i32, format: Enum, imageSize: i32, data: rawptr) ---
	...
	DrawElementsInstanced :: proc(mode: Enum, count: i32, type: Enum, offset: i32, instanceCount: i32) ---
...
GetActiveUniformBlockName :: proc(program: Program, uniformBlockIndex: i32, buf: []byte) -> string {
	foreign webgl2 {
		_GetActiveUniformBlockName :: proc "contextless" (program: Program, uniformBlockIndex: i32, buf: []byte, length: ^i32) ---
	}
	n: i32
